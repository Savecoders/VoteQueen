...
{
    public partial class UvoteFotogenea : UserControl
    {

        private static UvoteFotogenea _instance;
        ...
        public static UvoteFotogenea Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new UvoteFotogenea();
                }
                return _instance;
            }
        }

        public UvoteFotogenea()
        {
            InitializeComponent();
        }
        ...
        private async void UVoteFMCF_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if(await estudianteController.VerificarVotoFotogenia(SessionManager.GetUsuario().ID))
                {
                    lInfo.Text = "Ya has votado por tu candidata favorita a Miss Fotogenea";
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            ...
            if(result == DialogResult.Yes && candidataSelecionada.ID > 0)
            {
                ...
                Votacion votacion = new Votacion
                {
                    ...
                    TipoVotacion = TipoVotacion.MissFotogenia
                };
